<template>
  <aside
    class="fixed left-4 top-4 bottom-4 bg-white border border-gray-100 rounded-2xl shadow-xl flex flex-col z-50 transition-all duration-300 ease-in-out"
    :class="isCollapsed ? 'w-20' : 'w-64'"
  >

    <!-- Logo -->
    <div
      class="h-16 flex items-center justify-center border-b border-gray-50 overflow-hidden relative"
    >
    ...
    <nav class="flex-1 p-3 space-y-2">
      ...
      >
        ...
        >
          ...
          <!-- 图标 -->
          <div
            class="relative z-10 w-14 flex items-center justify-center flex-shrink-0"
          >
          ...
          <span
            v-if="!isCollapsed"
            class="relative z-10 ml-2 font-medium whitespace-nowrap"
          >
            {{ item.name }}
          </span>
    ...
    <!-- 折叠按钮 -->
    <div
      class="p-4 border-t border-gray-50 flex justify-center"
    >
...
const menuItems = [
...

  {
    ...
    icon:new URL(
      '@/assets/icons/MonitoringConsole.png',
      import.meta.url
    ).href
  },
...

  {
    ...
    path:'/app/resources',
    icon:new URL(
      '@/assets/icons/ResourceLibrary.png',
      import.meta.url
    ).href
  },
...

  {
    ...
    icon:new URL(
      '@/assets/icons/EnvironmentalManagement.png',
      import.meta.url
    ).href
  },
